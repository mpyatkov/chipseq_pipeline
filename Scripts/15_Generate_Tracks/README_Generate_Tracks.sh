...
##################################################################################
#Job output:
#The output of this job will be a "UCSC_Track_Lines" folder within the "Generate_Tracks" folder
#Within the "UCSC_Track_Lines" folder:
#(1) G*_Tracks_PileUp.txt:		
#	Use these track lines to view read pile-ups (BAM files)
#(2) G*_Tracks_Wiggle.txt:		
#	Use these tracks lines to view wiggle tracks (autoScale=off viewLimits=0.0:100.0)
#(3) G*_Tracks_Wiggle_autoON.txt:	
#	Use these tracks lines to view wiggle tracks (autoScale=on)
