...
cp ${DATA_DIR}/${Sample_ID}/fastq/bowtie2/StrgtPksRm/${Sample_ID}'_MACS2_output'/*.narrowPeak.bed ${OUTPUT_DIR_2}
done < Sample_Labels.temp
#Remove the temp file:
rm Sample_Labels.temp
rm Sample_Labels.txt
...
cp ${Dataset_DIR}/${Sample_ID}/fastq/bowtie2/StrgtPksRm/${Sample_ID}'_MACS2_output'/${Sample_ID}'_MACS2_peaks.narrowPeak.bed' ${Peaks_Called_DIR}
#---------------------------
done < Sample_Labels.temp
#Remove the temp file:
rm Sample_Labels.temp
